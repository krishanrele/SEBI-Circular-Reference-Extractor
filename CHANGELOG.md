...
## Version 1.1 — Added 3 more circulars
- Model: gemini-2.5-flash
...
## Version 1.2 — Ground Truth Adjustment + Prompt Update
- Changes made:
...
## Version 1.3 — Self-check prompt + fuzzy matching
- Changes made:
...
## Version 1.4 — Alias matching introduced
- Changes made:
...
## Version 1.5 — Type validation fix + ground truth completed
- Changes made:
